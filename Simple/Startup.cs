    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
           var connectionString = Configuration.GetSection("AppSettings:SqlServerConnection").Value; //获取数据库链接字符串
            ...
            var assemblysService = Assembly.LoadFile(Path.Combine(dllPath, "Simple.Service.dll"));
            ...
            var assemblysRepository = Assembly.LoadFile(Path.Combine(dllPath, "Simple.Repository.dll"));
